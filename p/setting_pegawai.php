...
<script type="text/javascript">
	document.title="Setting akun pegawai";
</script>
<div class="content">
	<div class="padding">
		<div class="bgwhite">
			<div class="padding">
				<h3 class="jdl">Setting akun pegawai</h3>
				<span class="label">* silahkan melakukan perubahan yang diperlukan untuk pegawi.</span>
				<form class="form-input" method="post" action="handler.php?action=edit_pegawai" style="padding-top: 30px;">
					<?php
					$f=$root->edit_pegawai();
					?>
					<label>Nama     : </label>
